...
public class Vector3 {
    ...
    public Vector3 multiply(final double[] matrix) {
        ...
        x = vx * matrix[Matrix4.Companion.getM00()] + vy * matrix[Matrix4.Companion.getM01()] + vz * matrix[Matrix4.Companion.getM02()] + matrix[Matrix4.Companion.getM03()];
        y = vx * matrix[Matrix4.Companion.getM10()] + vy * matrix[Matrix4.Companion.getM11()] + vz * matrix[Matrix4.Companion.getM12()] + matrix[Matrix4.Companion.getM13()];
        z = vx * matrix[Matrix4.Companion.getM20()] + vy * matrix[Matrix4.Companion.getM21()] + vz * matrix[Matrix4.Companion.getM22()] + matrix[Matrix4.Companion.getM23()];
        return this;
    }
    ...
    public Vector3 project(final double[] matrix) {
        double l_w = x * matrix[Matrix4.Companion.getM30()] + y * matrix[Matrix4.Companion.getM31()] + z * matrix[Matrix4.Companion.getM32()] + matrix[Matrix4.Companion.getM33()];

        return setAll(
            (x * matrix[Matrix4.Companion.getM00()] + y * matrix[Matrix4.Companion.getM01()] + z * matrix[Matrix4.Companion.getM02()] + matrix[Matrix4.Companion.getM03()]) / l_w,
            (x * matrix[Matrix4.Companion.getM10()] + y * matrix[Matrix4.Companion.getM11()] + z * matrix[Matrix4.Companion.getM12()] + matrix[Matrix4.Companion.getM13()]) / l_w,
            (x * matrix[Matrix4.Companion.getM20()] + y * matrix[Matrix4.Companion.getM21()] + z * matrix[Matrix4.Companion.getM22()] + matrix[Matrix4.Companion.getM23()]) / l_w);
    }
    ...
    public Vector3 transform(Quaternion quat) {
        ...
        return setAll(tmp.getX(), tmp.getY(), tmp.getZ());
    }
    ...
    public Quaternion getRotationTo(Vector3 direction) {
        ...
        if (d < 0.000001 - 1.0) {
            ...
            axis.normalize();
            q.fromAngleAxis(axis, MathUtil.INSTANCE.radiansToDegrees(MathUtil.INSTANCE.getPI()));
        } else {
